...
const STICKERS = [
  ...
  { id: 'mygo_matcha_parfait', emotion: 'happy', filename: 'Mygo表情包_抹茶芭菲.png' },
  { id: 'mygo_order', emotion: 'neutral', filename: 'Mygo表情包_请点单.png' },
  { id: 'mygo_send_message', emotion: 'neutral', filename: 'Mygo表情包_发送消息.png' },
  { id: 'mygo_no_way', emotion: 'surprised', filename: 'Mygo表情包_不会吧？.png' },
  { id: 'mygo_ha', emotion: 'surprised', filename: 'Mygo表情包_哈？.png' },
  { id: 'mygo_why', emotion: 'confused', filename: 'Mygo表情包_为什么！.png' },
  { id: 'mygo_peek', emotion: 'curious', filename: 'Mygo表情包_探头.png' },
  { id: 'mygo_let_me_see', emotion: 'curious', filename: 'Mygo表情包_让我看看.png' },
  { id: 'mygo_writing', emotion: 'thinking', filename: 'Mygo表情包_创作中.png' },
  { id: 'mygo_sleepy', emotion: 'sleepy', filename: 'Mygo表情包_刚睡醒.png' },
  { id: 'mygo_cry', emotion: 'sad', filename: 'Mygo表情包_大哭.png' },
  { id: 'mygo_melancholy', emotion: 'sad', filename: 'Mygo表情包_忧郁.png' },
  { id: 'mygo_what_about_me', emotion: 'sad', filename: 'Mygo表情包_那我呢？.png' },
  { id: 'mygo_angry', emotion: 'angry', filename: 'Mygo表情包_生气.png' },
  { id: 'mygo_block', emotion: 'angry', filename: 'Mygo表情包_Block!.png' },
  { id: 'mygo_no_fighting', emotion: 'angry', filename: 'Mygo表情包_不要吵架.png' },
