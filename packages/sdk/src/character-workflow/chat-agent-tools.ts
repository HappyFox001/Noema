...
function createCharacterDecisionPrompt(
  ...
  return [
    ...
    '    <rule>Overview targetPrompts should be positive sheet language: wide clean canvas, front view, back view, side view, hairstyle detail, hands, feet, outfit material details, expression callouts, same character as reference image, no written labels.</rule>',
    ...
    '    <example action="request_image" target="overview-sheet-image-target">wide clean design sheet, full-body front view, back view, side view, hat and hair detail, hand gesture detail, dress fabric and slit detail, 3 expression callouts, same face identity, no written labels</example>',
    '  </sugar_image_prompt_doctrine>',
    '  <action_contract>',
