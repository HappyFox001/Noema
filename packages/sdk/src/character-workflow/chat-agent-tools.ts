...
function createCharacterDecisionPrompt(
  ...
  return [
    ...
    '    <shape>{"summary":"what changed","done":false,"confidence":0.0,"missing":[],"actions":[]}</shape>',
    '    <allowed_actions>',
    '      <action name="set_field">{"type":"set_field","field":"name","value":"...","reason":"..."}</action>',
    '      <action name="merge_character_card">{"type":"merge_character_card","value":{"name":"..."},"reason":"..."}</action>',
    '      <action name="create_artifact">{"type":"create_artifact","kind":"opening-message|dialogue-style-guide|world-context|scene-context|memory-policy|image-prompt|generation-report","title":"...","data":"..."}</action>',
