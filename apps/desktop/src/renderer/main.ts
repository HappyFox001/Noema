...
const I18N: Record<LanguageCode, Record<string, string>> = {
  'zh-CN': {
    ...
    'chat.workflow.node.asset-builder': '资源目标',
    ...
    'chat.workflow.param.allowExpansion': '允许扩展',
    'chat.workflow.param.askUserThreshold': '询问阈值',
    'chat.workflow.param.assetCount': '图片数量',
  ...
  'en-US': {
    ...
    'chat.workflow.node.asset-builder': 'Asset Builder',
    ...
    'chat.workflow.param.allowExpansion': 'Allow Agent Expansion',
    'chat.workflow.param.askUserThreshold': 'Ask User Threshold',
    'chat.workflow.param.assetCount': 'Image Count',
