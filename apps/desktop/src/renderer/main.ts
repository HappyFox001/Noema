...
const I18N: Record<LanguageCode, Record<string, string>> = {
  'zh-CN': {
    ...
    'entry.chat': 'Chat',
    'entry.system': '系统页面',
    'chat.identity': 'Daphne',
    'chat.placeholder': 'Write a message...',
    'chat.profileDesc': 'College volleyball star Daphne Spencers dreams of going pro... and sneaking into the men’s locker room for an extra workout.',
    'chat.search': 'Search for a profile...',
    'chat.subtitle': 'Character chat',
    'chat.threadEva': 'Hey, it’s Daphne. Locker room’s empty...',
