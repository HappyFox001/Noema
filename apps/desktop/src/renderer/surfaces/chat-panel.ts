      ...
      },
      {
        ...
        spec: {
          ...
          configOverrides: {
            ...
            'avatar-image-target': { imageRole: 'avatar', assetPurpose: 'Final avatar.jpg for the role card: one single-subject bust portrait with one clear face, stable identity cues, and no panels, variants, duplicate faces, or reference-sheet layout.' },
            'avatar-image-control': { targetImageCount: 1, imageStyleDomain: 'auto', imageStylePreset: 'roleplay-character-avatar', shotType: 'bust', aspectRatio: '1:1', consistencyMode: 'same-character', seedMode: 'lock-character' },
