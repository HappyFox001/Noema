    ...
    return [
      {
        ...
        spec: {
          ...
          configOverrides: {
            ...
            'avatar-image-target': { imageRole: 'avatar', assetPurpose: 'Canonical identity-lock portrait. It should be a polished production avatar with clear face, strong appeal, stable visual identity cues, and no collage layout.' },
      ...
      },
      {
        ...
        spec: {
          ...
          configOverrides: {
            ...
            'avatar-image-target': { imageRole: 'avatar', assetPurpose: 'Canonical identity-lock portrait for later world or story reference images through graph reference links.' },
            'avatar-image-control': { targetImageCount: 1, imageStyleDomain: 'auto', imageStylePreset: 'roleplay-character-avatar', shotType: 'bust', aspectRatio: '1:1', consistencyMode: 'same-character', seedMode: 'lock-character' },
